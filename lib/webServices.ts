...
export const WEB_DESIGN_SERVICES = [
  ...
  {
    name: "Web Apps",
    text: "We design and develop digital products with the latest technologies such as TypeScript, Vercel Serverless Functions, React, Next.JS and Tailwind CSS. From an idea to a globally-scalable app, Buchanan Computer ensures your vision comes to life with the best possible design and development process.",
  },
]
