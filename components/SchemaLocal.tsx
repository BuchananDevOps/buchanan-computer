            ...
            <div className=" right-0 -left-1 top-1/2 space-y-1 overflow-hidden rounded-[18px] text-sm saturate-150">
              ...
              <div className="!my-[3px]">
                ...
                <div style={{ overflow: "visible" }}>
                  <div className=" whitespace-nowrap  border-l-2 border-[#40D763] bg-[#10481D]/50 py-px pl-sm text-green-700 shadow-[16px_2px_16px_4px_rgba(64,215,99,.4)] backdrop-blur-sm">
                    <div className=" inset-0 border-y border-[#40D763]/40" />+
                    {""}{" "}
                    <span className="text-white">&quot;provider&quot;:</span>{" "}
                    {"{"} <br />
                    <span className="text-white pl-8">&quot;@type&quot;:</span>
